...
class CSG2CAD_Dataset(Dataset):
    def __init__(
        ...
        """
        super(CSG2CAD_Dataset, self).__init__()
...
def get_dataloaders(
    ...
    """
    Generate a DataLoader for the CSG2CADDataset.
    ...
    for subset in subsets:
        # Create an instance of the CSG2CADDataset
        dataset = CSG2CAD_Dataset(
